...
import com.summerdewyes.mvvm_news_app.NewsApplication
    ...
    private suspend fun safeSearchNewsCall(searchQuery: String) {
        ...
        try{
            if (hasInternetConnection()){
                ...
                searchNews.postValue(Resource.Error("인터넷이 연결되어 있지 않습니다 :("))
            }

        } catch (t: Throwable){
            when (t) {
                is IOException -> searchNews.postValue(Resource.Error("네트워크 연결 실패"))
    ...
    private suspend fun safeBreakingNewsCall(countryCode: String) {
        ...
        try{
            if (hasInternetConnection()){
                ...
                breakingNews.postValue(Resource.Error("인터넷이 연결되어 있지 않습니다 :("))
            }

        } catch (t: Throwable){
            when (t) {
                is IOException -> breakingNews.postValue(Resource.Error("네트워크 연결 실패"))
